...
class ShippingForm(forms.ModelForm):
	...
	shipping_Town = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Town'}), required=False)
	...
	class Meta:
		...
		fields = ['shipping_full_name', 'shipping_email', 'shipping_address1', 'shipping_address2', 'shipping_city', 'shipping_Town', 'shipping_zipcode', 'shipping_country']
...
class PaymentForm(forms.Form):
	...
	card_town = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Billing Town'}), required=True)
